...
// Read lines from input and store the line numbers at which each word appears
map<string, vector<int> > crossRef(ifstream& in, vector<string> findWords(const string&))
{
